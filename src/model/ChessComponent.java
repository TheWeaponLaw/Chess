...
public abstract class ChessComponent extends JComponent {
    ...
    public int symbol = 0;
    public ChessboardPoint specialPawnPoint;
    public ChessColor chosenColor;
    ...
    public abstract List<ChessboardPoint> moveTo(ChessComponent[][] chessboard);
    ...
    protected void paintComponent(Graphics g) {
        ...
        g.fillRect(0, 0, this.getWidth(), this.getHeight());
        if (isChosen()) {
            if (chosenColor == ChessColor.BLACK) {
    ...
    public void setBackgroundColors(Color[] BACKGROUND_COLORS){
